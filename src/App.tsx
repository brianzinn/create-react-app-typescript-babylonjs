...
import { Vector3, Color3, PhysicsImpostor, Mesh, Nullable, FresnelParameters } from '@babylonjs/core';
...
const MainScene: React.FC = (props, context) => {
  ...
  return (
    <>
      ...
      <sphere ref={sphereRef} name="sphere1" diameter={2} segments={16} position={new Vector3(0, 2.5, 0)}>
        ...
        <standardMaterial name='material1'
          alpha={0.8}
          specularPower={16}
          diffuseColor={Color3.Black()}
          emissiveColor={new Color3(0.8, 0.8, 0.8)}
        ...
        >
          <cubeTexture
            ...
            rootUrl={'assets/textures/environment.dds'}
          />
        </standardMaterial>
